...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/emptyhead/Dropbox/내 Mac (gimhyeongjun-ui-MacBookPro.local)/Desktop/Python/Django/env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/emptyhead/Dropbox/내 Mac (gimhyeongjun-ui-MacBookPro.local)/Desktop/Python/Django/env/bin/deactivate.nu'
